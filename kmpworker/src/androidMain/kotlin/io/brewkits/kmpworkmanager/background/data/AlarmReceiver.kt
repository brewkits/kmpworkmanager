...
abstract class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
         ...
         */
        const val EXTRA_TASK_ID = "io.brewkits.kmpworkmanager.TASK_ID"
        const val EXTRA_WORKER_CLASS = "io.brewkits.kmpworkmanager.WORKER_CLASS"
        const val EXTRA_INPUT_JSON = "io.brewkits.kmpworkmanager.INPUT_JSON"
