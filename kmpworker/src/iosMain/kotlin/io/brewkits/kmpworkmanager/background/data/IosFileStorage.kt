 ...
 * File Structure:
 * ```
 * Library/Application Support/io.brewkits.kmpworkmanager/
...
internal class IosFileStorage {
    ...
    companion object {
        ...
        private const val BASE_DIR_NAME = "io.brewkits.kmpworkmanager"
    ...
    /**
     * Base directory path: Library/Application Support/io.brewkits.kmpworkmanager/
     */
