 ...
 * ```
 */
interface IosWorker : io.brewkits.kmpworkmanager.background.domain.Worker {
    /**
 ...
 * ```
 */
interface IosWorkerFactory : io.brewkits.kmpworkmanager.background.domain.WorkerFactory {
    /**
