...
import io.kmp.worker.background.domain.TaskRequest
 ...
 * File Structure:
 * ```
 * Library/Application Support/io.kmp.worker/
...
internal class IosFileStorage {
    ...
    companion object {
        ...
        private const val BASE_DIR_NAME = "io.kmp.worker"
    ...
    /**
     * Base directory path: Library/Application Support/io.kmp.worker/
     */
