...
### Metadata Scanning (iOS v2.4.3+)

**Before v2.4.3:** O(n) memory - loaded all task IDs into a list before filtering.
**After v2.4.3:** O(1) memory - uses lazy `Sequence` backed by `NSDirectoryEnumerator`.

| Number of Tasks | Memory (v2.4.0) | Memory (v2.4.3) | Improvement |
|-----------------|-----------------|-----------------|-------------|
| 1,000 tasks | ~100KB | ~50KB | 2x |
| 10,000 tasks | ~1MB | ~50KB | 20x |
| 50,000 tasks | ~5MB | ~50KB | **100x better** |
