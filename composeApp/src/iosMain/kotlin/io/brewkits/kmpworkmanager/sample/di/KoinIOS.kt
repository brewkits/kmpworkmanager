...
class KoinIOS : KoinComponent {
    ...
    private val singleTaskExecutor: io.brewkits.kmpworkmanager.sample.background.data.SingleTaskExecutor by inject()
     ...
     */
    fun getSingleTaskExecutor(): io.brewkits.kmpworkmanager.sample.background.data.SingleTaskExecutor = singleTaskExecutor
}