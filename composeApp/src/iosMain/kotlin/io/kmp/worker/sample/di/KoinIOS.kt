...
class KoinIOS : KoinComponent {
    ...
    private val singleTaskExecutor: io.kmp.worker.sample.background.data.SingleTaskExecutor by inject()
     ...
     */
    fun getSingleTaskExecutor(): io.kmp.worker.sample.background.data.SingleTaskExecutor = singleTaskExecutor
}